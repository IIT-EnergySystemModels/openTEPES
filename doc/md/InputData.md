...
| EfficiencyH2               | Round-trip efficiency of the hydrogen store, split evenly between the two directions as Efficiency is for an ESS: the inventory takes the charge times its square root, and gives up a tonne over the square root for every tonne withdrawn. Left out or blank means 1.0, a lossless store. A 0.0 is read as not given. This is a loss of hydrogen; the electricity a compressor draws is not modelled | p.u.                               |
