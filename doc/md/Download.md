...
The **openTEPES** model has been tested using these latest versions [Python 3.13.7](https://www.python.org/) and [Pyomo 6.10.0](https://pyomo.readthedocs.io/en/stable/), and it uses [Gurobi 13.0.1](https://www.gurobi.com/products/gurobi-optimizer/) as a commercial MIP solver for which a free academic license is available.
