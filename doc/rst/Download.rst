...
=======================
The **openTEPES** has been developed using `Python 3.10.11 <https://www.python.org/>`_ and `Pyomo 6.5.0 <https://pyomo.readthedocs.io/en/stable/>`_ and it uses `Gurobi 10.0.1 <https://www.gurobi.com/products/gurobi-optimizer/>`_ as commercial MIP solver for which a free academic license is available.
