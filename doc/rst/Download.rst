...
=======================
The **openTEPES** model has been tested using `Python 3.13.7 <https://www.python.org/>`_ and `Pyomo 6.9.5 <https://pyomo.readthedocs.io/en/stable/>`_, and it uses `Gurobi 13.0.0 <https://www.gurobi.com/products/gurobi-optimizer/>`_ as a commercial MIP solver for which a free academic license is available.
It uses Pyomo so that it is independent of the preferred solver. You can alternatively use one of the free solvers `HiGHS 1.12.0 <https://ergo-code.github.io/HiGHS/dev/installation/#Precompiled-Binaries>`_, `SCIP 9.2.4 <https://www.scipopt.org/index.php#download>`_, `GLPK 5.0 <https://www.gnu.org/software/glpk/>`_,
