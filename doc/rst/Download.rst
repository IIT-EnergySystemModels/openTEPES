...
Cases
-----
Here, you have the input files of a `small case study of 9 nodes <https://pascua.iit.comillas.edu/aramos/9n.zip>`_, another one like a `small Spanish system <https://pascua.iit.comillas.edu/aramos/sSEP.zip>`_ and the `RTS24 cas study <https://pascua.iit.comillas.edu/aramos/RTS24.zip>`_.
