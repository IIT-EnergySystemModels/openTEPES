...
=======================
The **openTEPES** model has been developed using `Python 3.12.2 <https://www.python.org/>`_ and `Pyomo 6.7.2 <https://pyomo.readthedocs.io/en/stable/>`_ and it uses `Gurobi 11.0.2 <https://www.gurobi.com/products/gurobi-optimizer/>`_ as commercial MIP solver for which a free academic license is available.
