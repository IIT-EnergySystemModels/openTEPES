...
=======================
The **openTEPES** model has been tested using `Python 3.13.7 <https://www.python.org/>`_ and `Pyomo 6.9.5 <https://pyomo.readthedocs.io/en/stable/>`_, and it uses `Gurobi 12.0.3 <https://www.gurobi.com/products/gurobi-optimizer/>`_ as a commercial MIP solver for which a free academic license is available.
