...
:math:`(\frac{p^p_{\omega ne} + ur^p_{\omega ne}}{\underline{GP}^p_{\omega ne}} + 1) \frac{1}{\sqrt{EF_e'}} \leq \frac{i^p_{\omega ne} - \underline{I}^p_{wne}}{DUR^p_{\omega n} \underline{GP}^p_{\omega ne}} \quad \forall p \omega ne`

or if there is enough storage capacity left for storing [GW] «``eESSReserveDwIfEnergy``»

:math:`(\frac{c^p_{\omega ne} + dr'^p_{\omega ne}}{\underline{GC}^p_{\omega ne}} + 1) \sqrt{EF_e'} \leq \frac{\overline{I}^p_{\omega ne} - i^p_{\omega ne}}{DUR^p_{\omega n} \underline{GC}^p_{\omega ne}} \quad \forall p \omega ne`
...
:math:`uc'^p_{\omega g} + uc'^p_{\omega g'} + ucc'^p_{\omega g} + ucc'^p_{\omega g'} \leq 1 \quad \forall p \omega gg'`
...
:math:`\sum_{e \in i} \frac{DUR^p_{\omega n}}{PF'_e} gc^p_{\omega ne} - \sum_{g \in i} DUR^p_{\omega n} PF'''_e gh^p_{\omega ng} + hns^p_{\omega ni} - hex^p_{\omega ni} = DUR^p_{\omega n} DH^p_{\omega ni} + \sum_{jc} fh^p_{\omega nijc} - \sum_{jc} fh^p_{\omega njic} \quad \forall p \omega ni`
