...
The :math:`\epsilon` is added to detect if the generator is ramping up/down. It is defined in the code as 5e-2. Below this percentage of the maximum ramping rate, the generator is considered stable.
