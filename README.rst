...
Gurobi
================================
Our another recomendation is the use  `Gurobi <https://www.gurobi.com/>`_ solver. However, it is commercial solver but most powerful than GPLK and CBC for large-scale problems. 
