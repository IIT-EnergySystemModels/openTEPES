...
def ModelFormulation(mTEPES):
    ...
    mTEPES.eTotalFCost = Constraint(
        rule=eTotalFCost, doc='system fixed    cost [MEUR]')
    ...
    mTEPES.eTotalGCost = Constraint(
        rule=eTotalGCost, doc='system variable generation operation cost [MEUR]')
    ...
    mTEPES.eTotalCCost = Constraint(
        rule=eTotalCCost, doc='system variable consumption operation cost [MEUR]')
    ...
    mTEPES.eTotalRCost = Constraint(
        rule=eTotalRCost, doc='system reliability cost [MEUR]')
    ...
    mTEPES.eTotalECost = Constraint(
        rule=eTotalECost, doc='system emission cost [MEUR]')
    ...
    mTEPES.eInstalGenConm = Constraint(
        mTEPES.sc, mTEPES.p, mTEPES.n, mTEPES.gc, rule=eInstalGenConm, doc='commitment  if installed unit [p.u.]')
    ...
    mTEPES.eInstalGenCap = Constraint(mTEPES.sc, mTEPES.p, mTEPES.n, mTEPES.gc,
                                      rule=eInstalGenCap, doc='output      if installed gen unit [p.u.]')
    ...
    mTEPES.eReserveUpIfEnergy = Constraint(mTEPES.sc, mTEPES.p, mTEPES.n, mTEPES.es,
                                           rule=eReserveUpIfEnergy, doc='up   operating reserve if energy available [GW]')

    print('eReserveUpIfEnergy    ... ', len(
        mTEPES.eReserveUpIfEnergy), ' rows')
    ...
    mTEPES.eReserveDwIfEnergy = Constraint(mTEPES.sc, mTEPES.p, mTEPES.n, mTEPES.es,
                                           rule=eReserveDwIfEnergy, doc='down operating reserve if energy available [GW]')

    print('eReserveDwIfEnergy    ... ', len(
        mTEPES.eReserveDwIfEnergy), ' rows')
    ...
    mTEPES.eESSReserveUpIfEnergy = Constraint(mTEPES.sc, mTEPES.p, mTEPES.n, mTEPES.es,
                                              rule=eESSReserveUpIfEnergy, doc='up   operating reserve if energy available [GW]')

    print('eESSReserveUpIfEnergy ... ', len(
        mTEPES.eESSReserveUpIfEnergy), ' rows')
    ...
    mTEPES.eESSReserveDwIfEnergy = Constraint(mTEPES.sc, mTEPES.p, mTEPES.n, mTEPES.es,
                                              rule=eESSReserveDwIfEnergy, doc='down operating reserve if energy available [GW]')

    print('eESSReserveDwIfEnergy ... ', len(
        mTEPES.eESSReserveDwIfEnergy), ' rows')
    ...
    mTEPES.eESSInventory = Constraint(
        mTEPES.sc, mTEPES.p, mTEPES.n, mTEPES.es, rule=eESSInventory, doc='ESS inventory balance [GWh]')
    ...
    def eESSTotalCharge(mTEPES, sc, p, n, es):
        if mTEPES.pMaxCharge[es] > 0:
            ...
            return Constraint.Skip
    mTEPES.eESSTotalCharge = Constraint(
        mTEPES.sc, mTEPES.p, mTEPES.n, mTEPES.es, rule=eESSTotalCharge, doc='total charge of a ESS unit [GW]')
