...
def InputData(CaseName, mTEPES):
    ...
    dfUpOperatingReserve = pd.read_csv('oT_Data_UpwardOperatingReserve_' + CaseName+'.csv', index_col=[0, 1, 2])
    dfDwOperatingReserve = pd.read_csv('oT_Data_DownwardOperatingReserve_'+CaseName+'.csv', index_col=[0, 1, 2])
