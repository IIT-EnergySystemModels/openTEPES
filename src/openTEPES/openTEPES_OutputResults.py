...
def OutputResults(CaseName, mTEPES):
    ...
    if len(mTEPES.es):
        ...
        plt.axis('equal')
        # plt.show()
        plt.savefig(CaseName+'/oT_ESSTechnologyEnergy_'+CaseName+'.png', bbox_inches=None, dpi=600)
    ...
    for sc,p in mTEPES.sc*mTEPES.p:
        ...
        plt.tight_layout()
        # plt.show()
        plt.savefig(CaseName+'/oT_TechnologyOutput_'+sc+'_'+p+'_'+CaseName+'.png', bbox_inches=None, dpi=600)
    ...
    plt.axis('equal')
    # plt.show()
    plt.savefig(CaseName+'/oT_TechnologyEnergy_'+CaseName+'.png', bbox_inches=None, dpi=600)
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig(CaseName+'/oT_LSRMC_'+CaseName+'.png', bbox_inches=None, dpi=600)
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig(CaseName+'/oT_WaterValue_'+CaseName+'.png', bbox_inches=None, dpi=600)
    ...
    # plt.show()
    plt.savefig(CaseName+'/oT_MapNetwork_'+CaseName+'.png', bbox_inches=None, dpi=600)
