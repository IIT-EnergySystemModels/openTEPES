...
def OutputResults(CaseName, mTEPES):
    ...
    if len(mTEPES.gc):
        ...
        OutputResults.to_csv('openTEPES/' + CaseName+'/oT_Result_GenerationInvestment_'+CaseName+'.csv', index=True, header=True)
    if len(mTEPES.lc):
        ...
        pd.pivot_table(OutputResults, values=str(mTEPES.vNetworkInvest), index=['InitialNode','FinalNode'], columns=['Circuit'], fill_value=0).to_csv('openTEPES/' + CaseName+'/oT_Result_NetworkInvestment_'+CaseName+'.csv', sep=',')
    ...
    OutputResults.to_frame(name='p.u.').reset_index().pivot_table(index=['level_0','level_1','level_2'], columns='level_3', values='p.u.').rename_axis(['Scenario','Period','LoadLevel'], axis=0).rename_axis([None], axis=1).to_csv('openTEPES/' + CaseName+'/oT_Result_GenerationCommitment_'+CaseName+'.csv', sep=',')
    ...
    OutputResults.to_frame(name='p.u.').reset_index().pivot_table(index=['level_0','level_1','level_2'], columns='level_3', values='p.u.').rename_axis(['Scenario','Period','LoadLevel'], axis=0).rename_axis([None], axis=1).to_csv('openTEPES/' + CaseName+'/oT_Result_GenerationStartUp_'   +CaseName+'.csv', sep=',')
    ...
    OutputResults.to_frame(name='p.u.').reset_index().pivot_table(index=['level_0','level_1','level_2'], columns='level_3', values='p.u.').rename_axis(['Scenario','Period','LoadLevel'], axis=0).rename_axis([None], axis=1).to_csv('openTEPES/' + CaseName+'/oT_Result_GenerationShutDown_'  +CaseName+'.csv', sep=',')
    ...
    if sum(mTEPES.pOperReserveUp[sc,p,n,ar] for sc,p,n,ar in mTEPES.sc*mTEPES.p*mTEPES.n*mTEPES.ar):
        ...
        OutputResults *= 1e3
        OutputResults.to_frame(name='MW').reset_index().pivot_table(index=['level_0','level_1','level_2'], columns='level_3', values='MW').rename_axis(['Scenario','Period','LoadLevel'], axis=0).rename_axis([None], axis=1).to_csv('openTEPES/' + CaseName+'/oT_Result_GenerationReserveUp_'     +CaseName+'.csv', sep=',')
        ...
        OutputResults = OutputResults.fillna(0)
        OutputResults *= 1e3
        OutputResults.to_frame(name='MW').reset_index().pivot_table(index=['level_0','level_1','level_2'], columns='level_3', values='MW').rename_axis(['Scenario','Period','LoadLevel'], axis=0).rename_axis([None], axis=1).to_csv('openTEPES/' + CaseName+'/oT_Result_ESSGenerationReserveUp_'  +CaseName+'.csv', sep=',')
    ...
    if sum(mTEPES.pOperReserveDw[sc,p,n,ar] for sc,p,n,ar in mTEPES.sc*mTEPES.p*mTEPES.n*mTEPES.ar):
        ...
        OutputResults = OutputResults.fillna(0)
        OutputResults *= 1e3
        OutputResults.to_frame(name='MW').reset_index().pivot_table(index=['level_0','level_1','level_2'], columns='level_3', values='MW').rename_axis(['Scenario','Period','LoadLevel'], axis=0).rename_axis([None], axis=1).to_csv('openTEPES/' + CaseName+'/oT_Result_GenerationReserveDown_'   +CaseName+'.csv', sep=',')
        ...
        OutputResults = OutputResults.fillna(0)
        OutputResults *= 1e3
        OutputResults.to_frame(name='MW').reset_index().pivot_table(index=['level_0','level_1','level_2'], columns='level_3', values='MW').rename_axis(['Scenario','Period','LoadLevel'], axis=0).rename_axis([None], axis=1).to_csv('openTEPES/' + CaseName+'/oT_Result_ESSGenerationReserveDown_'+CaseName+'.csv', sep=',')
    ...
    OutputResults.to_frame(name='MW ').reset_index().pivot_table(index=['level_0','level_1','level_2'],    columns='level_3', values='MW ').rename_axis(['Scenario','Period','LoadLevel'], axis=0).rename_axis([None], axis=1).to_csv('openTEPES/' + CaseName+'/oT_Result_GenerationOutput_'   +CaseName+'.csv', sep=',')
    ...
    if len(mTEPES.r):
        ...
        OutputResults.to_frame(name='MW').reset_index().pivot_table(index=['level_0','level_1','level_2'], columns='level_3', values='MW'  ).rename_axis(['Scenario','Period','LoadLevel'], axis=0).rename_axis([None], axis=1).to_csv('openTEPES/' + CaseName+'/oT_Result_RESCurtailment_'    +CaseName+'.csv', sep=',')
    ...
    OutputResults.to_frame(name='GWh').reset_index().pivot_table(index=['level_0','level_1','level_2'],    columns='level_3', values='GWh' ).rename_axis(['Scenario','Period','LoadLevel'], axis=0).rename_axis([None], axis=1).to_csv('openTEPES/' + CaseName+'/oT_Result_GenerationEnergy_'  +CaseName+'.csv', sep=',')
    ...
    OutputResults.to_frame(name='tCO2').reset_index().pivot_table(index=['level_0','level_1','level_2'],   columns='level_3', values='tCO2').rename_axis(['Scenario','Period','LoadLevel'], axis=0).rename_axis([None], axis=1).to_csv('openTEPES/' + CaseName+'/oT_Result_GenerationEmission_'+CaseName+'.csv', sep=',')
    ...
    if len(mTEPES.es):
        ...
        OutputResults.to_frame(name='MW' ).reset_index().pivot_table(index=['level_0','level_1','level_2'], columns='level_3', values='MW' ).rename_axis(['Scenario','Period','LoadLevel'], axis=0).rename_axis([None], axis=1).to_csv('openTEPES/' + CaseName+'/oT_Result_ESSChargeOutput_'    +CaseName+'.csv', sep=',')
        ...
        OutputResults.to_frame(name='GWh').reset_index().pivot_table(index=['level_0','level_1','level_2'], columns='level_3', values='GWh').rename_axis(['Scenario','Period','LoadLevel'], axis=0).rename_axis([None], axis=1).to_csv('openTEPES/' + CaseName+'/oT_Result_ESSChargeEnergy_'    +CaseName+'.csv', sep=',')
        ...
        OutputResults.to_frame(name='GWh').reset_index().pivot_table(index=['level_0','level_1','level_2'], columns='level_3', values='GWh').rename_axis(['Scenario','Period','LoadLevel'], axis=0).rename_axis([None], axis=1).to_csv('openTEPES/' + CaseName+'/oT_Result_ESSTechnologyEnergy_'+CaseName+'.csv', sep=',')
        ...
        plt.axis('equal')
        # plt.show()
        plt.savefig('openTEPES/' + CaseName+'/oT_ESSTechnologyEnergy_'+CaseName+'.png', bbox_inches=None, dpi=600)
        ...
        OutputResults *= 1e3
        OutputResults.to_frame(name='GWh').reset_index().pivot_table(index=['level_0','level_1','level_2'], columns='level_3', values='GWh', dropna=False).rename_axis(['Scenario','Period','LoadLevel'], axis=0).rename_axis([None], axis=1).to_csv('openTEPES/' + CaseName+'/oT_Result_ESSInventory_'+CaseName+'.csv', sep=',')
        ...
        OutputResults *= 1e3
        OutputResults.to_frame(name='GWh').reset_index().pivot_table(index=['level_0','level_1','level_2'], columns='level_3', values='GWh', dropna=False).rename_axis(['Scenario','Period','LoadLevel'], axis=0).rename_axis([None], axis=1).to_csv('openTEPES/' + CaseName+'/oT_Result_ESSSpillage_'+CaseName+'.csv', sep=',')

        OutputResults = pd.Series({Key:OptimalSolution.value*1e3 for Key,OptimalSolution in mTEPES.vESSCharge.items()})
        OutputResults = pd.Series(data=[OutputResults[sc,p,n].filter(mTEPES.t2g[gt]).sum() for sc,p,n,gt in mTEPES.sc*mTEPES.p*mTEPES.n*mTEPES.gt], index=pd.MultiIndex.from_tuples(list(mTEPES.sc*mTEPES.p*mTEPES.n*mTEPES.gt)))
        OutputResults.to_frame(name='MW' ).reset_index().pivot_table(index=['level_0','level_1','level_2'], columns='level_3', values='MW' ).rename_axis(['Scenario','Period','LoadLevel'], axis=0).rename_axis([None], axis=1).to_csv('openTEPES/' + CaseName+'/oT_Result_TechnologyCharge_'+CaseName+'.csv', sep=',')
    ...
    OutputResults = pd.Series(data=[OutputResults[sc,p,n].filter(mTEPES.t2g[gt]).sum() for sc,p,n,gt in mTEPES.sc*mTEPES.p*mTEPES.n*mTEPES.gt], index=pd.MultiIndex.from_tuples(list(mTEPES.sc*mTEPES.p*mTEPES.n*mTEPES.gt)))
    OutputResults.to_frame(name='MW').reset_index().pivot_table(index=['level_0','level_1','level_2'], columns='level_3', values='MW').rename_axis(['Scenario','Period','LoadLevel'], axis=0).rename_axis([None], axis=1).to_csv('openTEPES/' + CaseName+'/oT_Result_TechnologyOutput_'+CaseName+'.csv', sep=',')
    ...
    for sc,p in mTEPES.sc*mTEPES.p:
        ...
        plt.tight_layout()
        # plt.show()
        plt.savefig('openTEPES/' + CaseName+'/oT_TechnologyOutput_'+sc+'_'+p+'_'+CaseName+'.png', bbox_inches=None, dpi=600)

    OutputResults = pd.Series(data=[mTEPES.vTotalOutput[sc,p,n,g]()*mTEPES.pDuration[n] for sc,p,n,g in mTEPES.sc*mTEPES.p*mTEPES.n*mTEPES.g], index=pd.MultiIndex.from_tuples(list(mTEPES.sc*mTEPES.p*mTEPES.n*mTEPES.g)))
    OutputResults = pd.Series(data=[OutputResults[sc,p,n].filter(mTEPES.t2g[gt]).sum() for sc,p,n,gt in mTEPES.sc*mTEPES.p*mTEPES.n*mTEPES.gt], index=pd.MultiIndex.from_tuples(list(mTEPES.sc*mTEPES.p*mTEPES.n*mTEPES.gt)))
    OutputResults.to_frame(name='GWh').reset_index().pivot_table(index=['level_0','level_1','level_2'], columns='level_3', values='GWh').rename_axis(['Scenario','Period','LoadLevel'], axis=0).rename_axis([None], axis=1).to_csv('openTEPES/' + CaseName+'/oT_Result_TechnologyEnergy_'+CaseName+'.csv', sep=',')
    ...
    plt.axis('equal')
    # plt.show()
    plt.savefig('openTEPES/' + CaseName+'/oT_TechnologyEnergy_'+CaseName+'.png', bbox_inches=None, dpi=600)
    ...
    OutputResults.to_csv('openTEPES/' + CaseName+'/oT_Result_NetworkFlow_'+CaseName+'.csv', sep=',')
    ...
    OutputResults.index.names = [None] * len(OutputResults.index.names)
    OutputResults.to_csv('openTEPES/' + CaseName+'/oT_Result_NetworkUtilization_'+CaseName+'.csv', sep=',')
    ...
    pd.pivot_table(OutputResults, values=str(mTEPES.vTheta), index=['Scenario','Period','LoadLevel'], columns=['Node'], fill_value=0).to_csv('openTEPES/' + CaseName+'/oT_Result_NetworkAngle_'+CaseName+'.csv', sep=',')

    OutputResults = pd.DataFrame.from_dict(mTEPES.vENS.extract_values(), orient='index', columns=[str(mTEPES.vENS)])
    OutputResults *= 1e3
    OutputResults.index = pd.MultiIndex.from_tuples(OutputResults.index)
    OutputResults.index.names = ['Scenario','Period','LoadLevel','Node']
    pd.pivot_table(OutputResults, values=str(mTEPES.vENS), index=['Scenario','Period','LoadLevel'], columns=['Node'], fill_value=0).to_csv('openTEPES/' + CaseName+'/oT_Result_NetworkPNS_'+CaseName+'.csv', sep=',')
    ...
    OutputResults.to_frame(name='GWh').reset_index().pivot_table(index=['level_0','level_1','level_2'], columns='level_3', values='GWh').rename_axis(['Scenario','Period','LoadLevel'], axis=0).rename_axis([None], axis=1).to_csv('openTEPES/' + CaseName+'/oT_Result_NetworkENS_'+CaseName+'.csv', sep=',')
    ...
    OutputResults.to_frame(name='LSRMC').reset_index().pivot_table(index=['level_0','level_1','level_2'], columns='level_3', values='LSRMC').rename_axis(['Scenario','Period','LoadLevel'], axis=0).rename_axis([None], axis=1).to_csv('openTEPES/' + CaseName+'/oT_Result_LSRMC_'+CaseName+'.csv', sep=',')
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig('openTEPES/' + CaseName+'/oT_LSRMC_'+CaseName+'.png', bbox_inches=None, dpi=600)
