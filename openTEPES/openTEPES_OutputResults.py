...
def EconomicResults(DirName, CaseName, OptModel, mTEPES):
    ...
    DemPayment  = sum(mTEPES.pDiscountFactor[p] * mTEPES.pScenProb     [p,sc    ] * mTEPES.pLoadLevelWeight[n] * mTEPES.pDuration[n] * mTEPES.pDemand[p,sc,n,nd] * OptModel.LSRMC[p,sc,n,nd] for p,sc,n,nd in mTEPES.p*mTEPES.sc*mTEPES.n*mTEPES.nd) / 1e3
