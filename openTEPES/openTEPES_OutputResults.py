...
def EconomicResults(DirName, CaseName, OptModel, mTEPES):
    ...
    OutputData_5 = pd.concat(OutputData_5).to_frame(name="LineLosses_ij [GW]"    )
    OutputData_6 = pd.concat(OutputData_6).to_frame(name="PowerFlow_ij [GW]"     )
    OutputData_7 = pd.concat(OutputData_7).to_frame(name="LineLosses_ji [GW]"    )
    OutputData_8 = pd.concat(OutputData_8).to_frame(name="PowerFlow_ji [GW]"     )
