...
def ProblemSolving(DirName, CaseName, SolverName, OptModel, mTEPES, pIndLogConsole):
    ...
    print('Total generation  cost [MEUR]              ', sum((1/((1+mTEPES.pAnnualDiscRate())**(p-mTEPES.pCurrentYear()))) * mTEPES.pPeriodWeight[p] * mTEPES.pScenProb     [p,sc    ] * OptModel.vTotalGCost      [p,sc,n    ]() for p,sc,n     in mTEPES.p*mTEPES.sc*mTEPES.n))
    print('Total consumption cost [MEUR]              ', sum((1/((1+mTEPES.pAnnualDiscRate())**(p-mTEPES.pCurrentYear()))) * mTEPES.pPeriodWeight[p] * mTEPES.pScenProb     [p,sc    ] * OptModel.vTotalCCost      [p,sc,n    ]() for p,sc,n     in mTEPES.p*mTEPES.sc*mTEPES.n))
    print('Total emission    cost [MEUR]              ', sum((1/((1+mTEPES.pAnnualDiscRate())**(p-mTEPES.pCurrentYear()))) * mTEPES.pPeriodWeight[p] * mTEPES.pScenProb     [p,sc    ] * OptModel.vTotalECost      [p,sc,n    ]() for p,sc,n     in mTEPES.p*mTEPES.sc*mTEPES.n))
    print('Total reliability cost [MEUR]              ', sum((1/((1+mTEPES.pAnnualDiscRate())**(p-mTEPES.pCurrentYear()))) * mTEPES.pPeriodWeight[p] * mTEPES.pScenProb     [p,sc    ] * OptModel.vTotalRCost      [p,sc,n    ]() for p,sc,n     in mTEPES.p*mTEPES.sc*mTEPES.n))
