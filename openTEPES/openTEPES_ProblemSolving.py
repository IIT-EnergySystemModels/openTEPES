...
def ProblemSolving(DirName, CaseName, SolverName, OptModel, mTEPES, pIndLogConsole):
    ...
    print('Total genr invest cost [MEUR]              ', sum((1/((1+mTEPES.pAnnualDiscRate())**(p-mTEPES.pCurrentYear())))                                                                                                                                                    * mTEPES.pGenInvestCost[gc      ] * OptModel.vGenerationInvest[p,gc      ]() for p,gc       in mTEPES.p*mTEPES.gc         ))
    print('Total retr invest cost [MEUR]              ', sum((1/((1+mTEPES.pAnnualDiscRate())**(p-mTEPES.pCurrentYear())))                                                                                                                                                    * mTEPES.pGenRetireCost[gd      ] * OptModel.vGenerationRetire[p,gd      ]() for p,gd       in mTEPES.p*mTEPES.gd         ))
    print('Total line invest cost [MEUR]              ', sum((1/((1+mTEPES.pAnnualDiscRate())**(p-mTEPES.pCurrentYear())))                                                                                                                                                    * mTEPES.pNetFixedCost [ni,nf,cc] * OptModel.vNetworkInvest   [p,ni,nf,cc]() for p,ni,nf,cc in mTEPES.p*mTEPES.lc         ))
    print('Total generation  cost [MEUR]              ', sum((1/((1+mTEPES.pAnnualDiscRate())**(p-mTEPES.pCurrentYear()))) * (((1+mTEPES.pAnnualDiscRate())**(mTEPES.pPeriodWeight[p])-1)/(mTEPES.pAnnualDiscRate()*(1+mTEPES.pAnnualDiscRate())**(mTEPES.pPeriodWeight[p]))) * mTEPES.pScenProb     [p,sc    ] * OptModel.vTotalGCost      [p,sc,n    ]() for p,sc,n     in mTEPES.p*mTEPES.sc*mTEPES.n))
    print('Total consumption cost [MEUR]              ', sum((1/((1+mTEPES.pAnnualDiscRate())**(p-mTEPES.pCurrentYear()))) * (((1+mTEPES.pAnnualDiscRate())**(mTEPES.pPeriodWeight[p])-1)/(mTEPES.pAnnualDiscRate()*(1+mTEPES.pAnnualDiscRate())**(mTEPES.pPeriodWeight[p]))) * mTEPES.pScenProb     [p,sc    ] * OptModel.vTotalCCost      [p,sc,n    ]() for p,sc,n     in mTEPES.p*mTEPES.sc*mTEPES.n))
    print('Total emission    cost [MEUR]              ', sum((1/((1+mTEPES.pAnnualDiscRate())**(p-mTEPES.pCurrentYear()))) * (((1+mTEPES.pAnnualDiscRate())**(mTEPES.pPeriodWeight[p])-1)/(mTEPES.pAnnualDiscRate()*(1+mTEPES.pAnnualDiscRate())**(mTEPES.pPeriodWeight[p]))) * mTEPES.pScenProb     [p,sc    ] * OptModel.vTotalECost      [p,sc,n    ]() for p,sc,n     in mTEPES.p*mTEPES.sc*mTEPES.n))
    print('Total reliability cost [MEUR]              ', sum((1/((1+mTEPES.pAnnualDiscRate())**(p-mTEPES.pCurrentYear()))) * (((1+mTEPES.pAnnualDiscRate())**(mTEPES.pPeriodWeight[p])-1)/(mTEPES.pAnnualDiscRate()*(1+mTEPES.pAnnualDiscRate())**(mTEPES.pPeriodWeight[p]))) * mTEPES.pScenProb     [p,sc    ] * OptModel.vTotalRCost      [p,sc,n    ]() for p,sc,n     in mTEPES.p*mTEPES.sc*mTEPES.n))
