"""
Open Generation, Storage, and Transmission Operation and Expansion Planning Model with RES and ESS (openTEPES) - February 25, 2026
"""
...
def NetworkH2OperationModelFormulation(OptModel, mTEPES, pIndLogConsole, p, sc, st):
    ...
    def eTotalRH2Cost(OptModel,n):
        return OptModel.vTotalRH2Cost[p,sc,n] == mTEPES.pLoadLevelDuration[p,sc,n]() * mTEPES.pH2NSCost * sum(OptModel.vH2NS[p,sc,n,nd] for nd in mTEPES.nd if sum(1 for el in l2n[nd]) + sum(1 for nf,cc in lout[nd]) + sum(1 for ni,cc in lin[nd]))
