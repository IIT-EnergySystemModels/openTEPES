...
def openTEPES_run(DirName, CaseName, SolverName):
    ...
    #%% model declaration
    mTEPES = ConcreteModel('Open Generation and Transmission Operation and Expansion Planning Model with RES and ESS (openTEPES) - Version 4.2.4 - December 30, 2021')
