...
def openTEPES_run(DirName, CaseName, SolverName, pIndOutputResults, pIndLogConsole,
    ...
    #%% model declaration
    mTEPES = ConcreteModel('Open Generation, Storage, and Transmission Operation and Expansion Planning Model with RES and ESS (openTEPES) - Version 4.19.0rc - September 18, 2026')
    ...
    print(                 'Open Generation, Storage, and Transmission Operation and Expansion Planning Model with RES and ESS (openTEPES) - Version 4.19.0rc - September 18, 2026', file=open(f'{_path}/openTEPES_version_{CaseName}.log','w'))
