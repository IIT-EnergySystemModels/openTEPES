"""
Open Generation, Storage, and Transmission Operation and Expansion Planning Model with RES and ESS (openTEPES) - October 05, 2023
"""
...
def openTEPES_run(DirName, CaseName, SolverName, pIndOutputResults, pIndLogConsole):
    ...
    #%% model declaration
    mTEPES = ConcreteModel('Open Generation, Storage, and Transmission Operation and Expansion Planning Model with RES and ESS (openTEPES) - Version 4.14.3 - October 05, 2023')
    print(                 'Open Generation, Storage, and Transmission Operation and Expansion Planning Model with RES and ESS (openTEPES) - Version 4.14.3 - October 05, 2023', file=open(_path+'/openTEPES_version_'+CaseName+'.log','a'))
